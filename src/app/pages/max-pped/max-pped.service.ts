...
export class MaxPpedService {
  ...
  private srppedPerCustomer = environment.BaseURL + '/api/v1/srpped/srppedPerCustomer'
  private srppedPerRoute = environment.BaseURL + '/api/v1/srpped/srppedPerRoute'
  private srppedPerRouteCustomers = environment.BaseURL + '/api/v1/srpped/srppedPerRouteCustomers'
